...
const (
	...
	// https://www.iana.org/assignments/service-names-port-numbers/service-names-port-numbers.xhtml?search=kwbasedb
	//
	...
	DefaultCertsDirectory = "${HOME}/.kwbase-certs"
	...
	// default restful api port
	DefaultRestfulPort = "8080"

	// default restful timeout
	DefaultRestfulTimeOut = "60"
)
...
var (
	...
	defaultRaftLogTruncationThreshold = envutil.EnvOrDefaultInt64(
		"KWBASE_RAFT_LOG_TRUNCATION_THRESHOLD", 4<<20 /* 4 MB */)
	...
	defaultRaftMaxSizePerMsg = envutil.EnvOrDefaultInt(
		"KWBASE_RAFT_MAX_SIZE_PER_MSG", 16<<10 /* 16 KB */)
	...
	defaultRaftMaxCommittedSizePerReady = envutil.EnvOrDefaultInt(
		"KWBASE_RAFT_MAX_COMMITTED_SIZE_PER_READY", 64<<20 /* 64 MB */)
	...
	defaultRaftMaxInflightMsgs = envutil.EnvOrDefaultInt(
		"KWBASE_RAFT_MAX_INFLIGHT_MSGS", 64)
)
