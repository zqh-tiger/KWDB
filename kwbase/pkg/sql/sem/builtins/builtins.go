...
import (
	...
	"gitee.com/kwbasedb/kwbase/pkg/sql/protoreflect"
...
var builtins = map[string]builtinDefinition{
	...
	"to_dec": makeBuiltin(defProps(),
		tree.Overload{
			Types:      tree.ArgTypes{{"val", types.Int}},
			ReturnType: tree.FixedReturnType(types.String),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("to_dec() used in KWDB, kwbase not really implemented")
			},
		},
		tree.Overload{
			Types:      tree.ArgTypes{{"val", types.String}},
	...
	"to_oct": makeBuiltin(defProps(),
		tree.Overload{
			Types:      tree.ArgTypes{{"val", types.Int}},
			ReturnType: tree.FixedReturnType(types.String),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("to_oct() used in KWDB, kwbase not really implemented")
			},
		},
		tree.Overload{
			Types:      tree.ArgTypes{{"val", types.String}},
	...
	"to_bin": makeBuiltin(defProps(),
		tree.Overload{
			Types:      tree.ArgTypes{{"val", types.Int}},
			ReturnType: tree.FixedReturnType(types.String),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("to_bin() used in KWDB, kwbase not really implemented")
			},
		},
		tree.Overload{
			Types:      tree.ArgTypes{{"val", types.String}},
	...
	// function to convert internal data structures to JSON format
	"kwdbdb_internal.pb_to_json": makeBuiltin(
		jsonProps(),
		func() []tree.Overload {
...
| m/n  | no                               | yes                                  |`,
	...
	"leftbit": makeBuiltin(defProps(),
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.Int}, {"set", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("leftbit() used in KWDB, kwbase not really implemented")
			},
			Info: "used in KWDB, kwbase incorrectly implemented.",
		},
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.Float}, {"set", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("leftbit() used in KWDB, kwbase not really implemented")
			},
		...
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.Timestamp}, {"set", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("leftbit() used in KWDB, kwbase not really implemented")
			},
		...
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.Bool}, {"set", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("leftbit() used in KWDB, kwbase not really implemented")
			},
		...
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.String}, {"set", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("leftbit() used in KWDB, kwbase not really implemented")
			},
	...
	"subbit": makeBuiltin(defProps(),
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.Int}, {"set1", types.Int}, {"set2", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("subbit() used in KWDB, kwbase not really implemented")
			},
			Info: "used in KWDB, kwbase incorrectly implemented.",
		},
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.Float}, {"set1", types.Int}, {"set2", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("subbit() used in KWDB, kwbase not really implemented")
			},
		...
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.Timestamp}, {"set1", types.Int}, {"set2", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("subbit() used in KWDB, kwbase not really implemented")
			},
		...
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.Bool}, {"set1", types.Int}, {"set2", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("subbit() used in KWDB, kwbase not really implemented")
			},
		...
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.String}, {"set1", types.Int}, {"set2", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("subbit() used in KWDB, kwbase not really implemented")
			},
	...
	"rightbit": makeBuiltin(defProps(),
		tree.Overload{
			Types:      tree.ArgTypes{{"input", types.Int}, {"set", types.Int}},
			ReturnType: tree.FixedReturnType(types.VarBit),
			Fn: func(_ *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				return nil, errors.Newf("rightbit() used in KWDB, kwbase not really implemented")
			},
			Info: "used in KWDB, kwbase incorrectly implemented.",
		},
		tree.Overload{
	...
	// See https://gitee.com/kwbasedb/kwbase/issues/21564
	"setval": makeBuiltin(
		tree.FunctionProperties{
			Category:         categorySequences,
			DistsqlBlacklist: true,
	...
	"experimental_strftime": makeBuiltin(
		...
		tree.Overload{
			...
			ReturnType: tree.FixedReturnType(types.String),
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				fromTime := args[0].(*tree.DTimestampTZ).Time.In(ctx.GetLocation())
				format := string(tree.MustBeDString(args[1]))
				t, err := strtime.Strftime(fromTime, format)
				if err != nil {
					return nil, err
...
may increase either contention or retry errors, or both.`,
	...
	"extract": makeBuiltin(
		...
		tree.Overload{
			Types:      tree.ArgTypes{{"element", types.String}, {"input", types.Int}},
			ReturnType: tree.FixedReturnType(types.Float),
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				// convert int to timestamp
				arg1 := int64(tree.MustBeDInt(args[1]))
				fromTS := timeutil.FromUnixMicros(arg1 * 1e3)
				timeSpan := strings.ToLower(string(tree.MustBeDString(args[0])))
				return extractTimeSpanFromTimestamp(ctx, fromTS, timeSpan)
			},
			Info: "Extracts `element` from `input`.\n\n" +
				"Compatible elements: millennium, century, decade, year, isoyear,\n" +
				"quarter, month, week, dayofweek, isodow, dayofyear, julian,\n" +
	...
	"st_buffer": makeBuiltin(tree.FunctionProperties{Category: categoryGEO, ForbiddenExecInTSEngine: true},
		tree.Overload{
			Types:      tree.ArgTypes{{"geo", types.Geometry}, {"radius", types.Float}},
			ReturnType: tree.FixedReturnType(types.Geometry),
			Fn: func(evalCtx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				line, err := geos.FromWKT(string(tree.MustBeDString(args[0])))
				if err != nil {
					log.Error(context.TODO(), geos.LoadMessage())
					return nil, err
				}
				radius := float64(tree.MustBeDFloat(args[1]))
				buf, err := line.Buffer(radius)
				if err != nil {
					log.Error(context.TODO(), geos.LoadMessage())
					return nil, err
				}
			...
			Info: "This function is used to create a buffer",
		},
	),
	...
	"st_distance": makeBuiltin(
		...
		tree.Overload{
			Types:      tree.ArgTypes{{"geo1", types.Geometry}, {"geo2", types.Geometry}},
			ReturnType: tree.FixedReturnType(types.Float),
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				geo1, err := geos.FromWKT(string(tree.MustBeDString(args[0])))
				if err != nil {
					log.Error(context.TODO(), geos.LoadMessage())
					return nil, err
				}
				geo2, err := geos.FromWKT(string(tree.MustBeDString(args[1])))
				if err != nil {
					log.Error(context.TODO(), geos.LoadMessage())
					return nil, err
				}
				distance, err := geo1.Distance(geo2)
				if err != nil {
					log.Error(context.TODO(), geos.LoadMessage())
					return nil, err
				}
	...
	"st_dwithin": makeBuiltin(
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				inputDist := float64(tree.MustBeDFloat(args[2]))
				actualDist, err := geo1.Distance(geo2)
				if err != nil {
					log.Error(context.TODO(), geos.LoadMessage())
					return nil, err
				}
				return tree.MakeDBool(actualDist <= inputDist), nil
			},
			Info: "This function checks whether two geometric objects are within a specified distance of each other.",
		},
	),
	...
	"st_contains": makeBuiltin(
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				contain, err := geo1.Contains(geo2)
				if err != nil {
					log.Error(context.TODO(), geos.LoadMessage())
					return nil, err
				}
				return tree.MakeDBool(tree.DBool(contain)), nil
			},
			Info: "This function checks whether one geometry completely contains another geometry.",
		},
	),
	...
	"st_intersects": makeBuiltin(
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				intersect, err := geo1.Intersects(geo2)
				if err != nil {
					log.Error(context.TODO(), geos.LoadMessage())
					return nil, err
				}
				return tree.MakeDBool(tree.DBool(intersect)), nil
			},
			Info: "This function checks whether two geometries intersect or overlap with each other.",
		},
	),
	...
	"st_equals": makeBuiltin(
		...
		tree.Overload{
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				equal, err := geo1.Equals(geo2)
				if err != nil {
					log.Error(context.TODO(), geos.LoadMessage())
					return nil, err
				}
				return tree.MakeDBool(tree.DBool(equal)), nil
			},
			Info: "This function checks whether two geometries are exactly equal to each other.",
		},
	),
	...
	"st_touches": makeBuiltin(
		...
		tree.Overload{
			...
			Info: "This function checks whether two geometries share a common boundary but do not overlap or intersect with each other.",
		},
	),
	...
	"st_covers": makeBuiltin(
		...
		tree.Overload{
			...
			Info: "This function checks whether one geometry object completely covers another.",
		},
	),
	...
	"st_area": makeBuiltin(
		tree.FunctionProperties{Category: categoryGEO, ForbiddenExecInTSEngine: true},
		tree.Overload{
			Types:      tree.ArgTypes{{"geo1", types.Geometry}},
			ReturnType: tree.FixedReturnType(types.Float),
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				geo1, err := geos.FromWKT(string(tree.MustBeDString(args[0])))
				if err != nil {
			...
			Info: "This function is used to calculate the area of a geometry.",
		},
	),
	...
	"kwdb_internal.locality_value": makeBuiltin(
		tree.FunctionProperties{Category: categorySystemInfo},
		tree.Overload{
	...
	"kwdb_internal.node_executable_version": makeBuiltin(
		tree.FunctionProperties{Category: categorySystemInfo},
		tree.Overload{
			Types:      tree.ArgTypes{},
			ReturnType: tree.FixedReturnType(types.String),
	...
	"kwdb_internal.cluster_id": makeBuiltin(
		tree.FunctionProperties{Category: categorySystemInfo},
		tree.Overload{
			Types:      tree.ArgTypes{},
			ReturnType: tree.FixedReturnType(types.Uuid),
	...
	"kwdb_internal.cluster_name": makeBuiltin(
		tree.FunctionProperties{Category: categorySystemInfo},
		tree.Overload{
			Types:      tree.ArgTypes{},
			ReturnType: tree.FixedReturnType(types.String),
	...
	"kwdb_internal.encode_key": makeBuiltin(
		tree.FunctionProperties{Category: categorySystemInfo},
		tree.Overload{
			Types: tree.ArgTypes{
				{"table_id", types.Int},
	...
	"kwdb_internal.force_error": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
			Impure:   true,
		},
	...
	"kwdb_internal.notice": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
			Impure:   true,
		},
	...
	"kwdb_internal.force_assertion_error": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
			Impure:   true,
		},
	...
	"kwdb_internal.force_panic": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
			Impure:   true,
		},
	...
	"kwdb_internal.force_log_fatal": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
			Impure:   true,
		},
	...
	"kwdb_internal.force_retry": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
			Impure:   true,
		},
			...
			Fn: func(ctx *tree.EvalContext, args tree.Datums) (tree.Datum, error) {
				...
				if elapsed.Compare(minDuration) < 0 {
					return nil, ctx.Txn.GenerateForcedRetryableError(
						ctx.Ctx(), "forced by kwdb_internal.force_retry()")
				}
				return tree.DZero, nil
			},
			Info: "This function is used only by CockroachDB's developers for testing purposes.",
	...
	"kwdb_internal.lease_holder": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
		},
		tree.Overload{
	...
	// fields.
	"kwdb_internal.pretty_key": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
		},
		tree.Overload{
	...
	"kwdb_internal.range_stats": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
		},
		tree.Overload{
	...
	"kwdb_internal.get_namespace_id": makeBuiltin(
		tree.FunctionProperties{Category: categorySystemInfo},
		tree.Overload{
	...
	"kwdb_internal.get_zone_config": makeBuiltin(
		tree.FunctionProperties{Category: categorySystemInfo},
		tree.Overload{
	...
	"kwdb_internal.set_vmodule": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
			Impure:   true,
		},
		tree.Overload{
			...
			Info: "Set the equivalent of the `--vmodule` flag on the gateway node processing this request; " +
				...
				"Example syntax: `kwdb_internal.set_vmodule('recordio=2,file=1,gfs*=3')`. " +
				"Reset with: `kwdb_internal.set_vmodule('')`. " +
	...
	"kwdb_internal.num_inverted_index_entries": makeBuiltin(
		tree.FunctionProperties{
			Category:     categorySystemInfo,
			NullableArgs: true,
		},
	...
	"kwdb_internal.is_admin": makeBuiltin(
		tree.FunctionProperties{
			Category:         categorySystemInfo,
			DistsqlBlacklist: true,
		},
	...
	"kwdb_internal.round_decimal_values": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
		},
		tree.Overload{
	...
	"kwdb_internal.completed_migrations": makeBuiltin(
		tree.FunctionProperties{
			Category: categorySystemInfo,
		},
		tree.Overload{
