...
// Shortinsert is the structure of tsinsert_direct
type Shortinsert struct {
	isTsTable          bool
	isInsert           bool
	symbol             bool
...
func (s *scanner) cleanup() {
	s.bytesPrealloc = nil
	s.shortinsert.Columnsname = s.shortinsert.Columnsname[:0]
	s.shortinsert.InsertValues = s.shortinsert.InsertValues[:0]
	s.shortinsert.ValuesType = s.shortinsert.ValuesType[:0]
	s.shortinsert.db = ""
	s.shortinsert.tb = ""
}
